...
from mlb.sim.lineups import lineup_from_feed, starting_batters_from_feed
from mlb.sim.matchup import MatchupProviderFactory
from mlb.sim.pitch_mix import PitchMixProfiles
from mlb.sim.team_strength import TeamStrengthPredictor
...
def build_day_ahead_simulator(
    *,
    ...
    if pitch_type_model_dir is not None:
        from mlb.sim.pitch_mix import PitchModelCountProfiles
...
def build_projected_lineups(
    ...
    *,
    ...
    for side in ("away", "home"):
        ...
        from mlb.sim.db_games import trailing_reliever_pool
