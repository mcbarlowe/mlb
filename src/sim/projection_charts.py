...
def write_projection_graphics(
    ...
    *,
    ...
    from src.live.card_html import HtmlCardRenderer
...
def _logo_html(team: TeamInfo) -> str:
    if team.team_id < 100:
        return ""
    from src.live.card_html import team_logo_data_url
...
def _brand_footer_html() -> str:
    from src.live.card_html import _brand_footer_html as brand_footer_html
